        ...
        return(
            <div className="service" style={{backgroundColor:"#F5F5F5"}}>
                <div className="serviceBg" style={{backgroundImage: `url(${Background})`}}>
                    <h2 id="h2">Salon At Home Service in {this.props.mainPageState.city}</h2>
                </div>
                ...
                <div className="info" id="scrollspy">
                    <Scrollspy items={ ['How it Works', 'Professionals', 'Customer Reviews'] } currentClassName="is-current">
                                ...
                                <li><a href="#Professionals">Beauticians</a></li>
                    ...
                    <ul>
                        <li>
                            ...
                            <div>
                                ...
                                <p>Select from various salon packages and services</p>
                        ...
                        <Button id="bookNow" style={{width:"100%", margin:"auto"}} onClick={() => this.props.history.push('/Salon/salonAtHomeWomen/shop')}>Book Now!</Button>
                ...
                <div className="serviceBox">
                    <div className="serviceBoxButtons">
                        <h4>View All Beauty Services:</h4>
                        <div className="serviceButtonGroup">
                         
                            <button onClick={() => this.props.history.push('/Salon/salonAtHomeWomen/shop')}>
