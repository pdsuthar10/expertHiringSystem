...
import Background from '../../../../assets/img/serviceBackgrounds/rf.jpg'
import '../../services.css'
        ...
        return(
            <div className="service" style={{backgroundColor:"#F5F5F5"}}>
                <div className="serviceBg" style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3),
                    ...
                    <h2 id="h2">Best Refrigerator Repair Service in {this.props.mainPageState.city}</h2>
                </div>
                ...
                <section className="info works" id="Works" >
                    ...
                    <ul>
                        ...
                        <Button id="bookNow" style={{width:"100%", margin:"auto"}} onClick={() => this.props.history.push('/ApplianceRepair/fridgeRepair/shop/#Service')}>Book Now!</Button>
                ...
                <section className="info professionals" id="Professionals">
                    <h4>Technicians</h4>
                    <h6>{this.state.professionals.length} Fridge Repair Service Professionals in {this.props.mainPageState.city}</h6>
                    <hr></hr>
                ...
                <section className="info reviews" id="Reviews">
                    ...
                    <h6>of Fridge Repair Service Professionals in {this.props.mainPageState.city}</h6>                   
...
export default connect(mapStateToProps, { setSearch })(FridgeRepair);